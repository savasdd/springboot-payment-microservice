...
public interface StockRepository extends JpaRepository<Stock, Long>, JpaSpecificationExecutor<Stock>, BaseRepository<Stock, Long> {
    ...
    List<Stock> findAllStockByStatusList(RecordStatus status, List<String> languages);
